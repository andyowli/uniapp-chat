<template>
	<view class="page">
		<view class="container">
			<view class="register-box" :class="{'slide-up':regClass}">
				<h2 class="register-title" @tap="res">
					<text>没有账号，去</text>注册
				</h2>
			...
			<view class="login-box" :class="{'slide-up':isClass}">
				<view class="center">
					<h2 class="login-title" @tap="title">
						<text>已有账号，去</text>登录
					</h2>
					<view class="input-box">
						<input type="text" placeholder="用户名">
...
<style lang="scss" scoped>
	...
	.login-box.slide-up .login-title text,
	.register-box.slide-up .register-title text{
	    margin-right: 5px;
